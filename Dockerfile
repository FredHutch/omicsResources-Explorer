...
RUN R -e "install.packages(c('dplyr', 'shiny', 'googlesheets4', 'shinyglide', 'shinyWidgets', 'readxl', 'bslib'), repos='https://cran.rstudio.com/')"
...
RUN R -f check.R --args dplyr shiny googlesheets4 shinyglide shinyWidgets readxl bslib
